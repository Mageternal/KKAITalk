...
namespace KKAITalk
{
    ...
    public class AITalkPlugin : BaseUnityPlugin
    {
        ...
        private void TriggerHSceneIntro(string mode)
        {
            ...
            {
                case "aibu":
                    prompt = "[system]:[H场景开始爱抚阶段，用符合角色性格与情形的话说一句话。]"; // TODO: aibu阶段开始
                    break;
                case "houshi":
                    prompt = "[system]:[H场景开始侍奉阶段，用符合角色性格与情形的话说一句话。]"; // TODO: houshi阶段开始
                    break;
                case "sonyu":
                    prompt = "[system]:[H场景开始正式H阶段，用符合角色性格与情形的话说一句话。]"; // TODO: sonyu阶段开始
                    break;
            }
